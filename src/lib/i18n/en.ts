...
export const en: Translation = {
  ...
  plus: {
    ...
    subheading: "A deeper toolkit for staying on track, for when the free plan isn't quite enough.",
    previewNote: "ClearPath Plus isn't available to buy yet — this is a preview. Leave your email and we'll let you know when it launches. Nothing is charged.",
    monthly: 'Monthly',
    annual: 'Annual',
    perMonth: '/mo',
    perYear: '/yr',
    saveBadge: (percent) => `Save ${percent}%`,
    freeTitle: 'Free',
    freePrice: 'R0',
    freeFeatures: [
    ...
    plusFeatures: [
      'Email and SMS payment reminders, not just in-app',
      'Historical progress — see your trend over time, not just where you are today',
      'Advanced simulator: compare multiple scenarios side by side, model lump-sum payments',
      'Deeper reports and analytics',
      'Personalised planning tips based on your own numbers',
    ],
    emailPlaceholder: 'you@example.com',
    notifyButton: 'Notify me when Plus launches',
    joining: 'Adding you…',
    joinedTitle: "You're on the list.",
    joinedBody: "We'll email you as soon as ClearPath Plus is ready. Thanks for the interest — it genuinely helps us decide what to build next.",
    errorGeneric: "Something went wrong — please try again in a moment.",
    errorInvalidEmail: 'Enter a valid email address.',
    notConfigured: "Waitlist signup isn't available in this environment right now.",
    closeLabel: 'Close',
  },
  education: {
    openLabel: 'Learn',
